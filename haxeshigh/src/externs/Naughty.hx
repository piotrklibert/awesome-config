 ...
 * @param screens lua.Table<String, Dynamic>  Table of screens on which notifications should be
 destroyed. If nil, destroy notifications on all screens.
 * @param reason naughty.notification_closed_reason  Reason for closing
 notifications.
 */
static function destroy_all_notifications(screens: lua.Table<String, Dynamic>, reason: naughty.notification_closed_reason): true|nil;
/**
 * Get notification by ID
 * @see lib/naughty/core.lua:401
 * @param id Dynamic  ID of the notification
 */
static function get_by_id(id: Dynamic);
}
