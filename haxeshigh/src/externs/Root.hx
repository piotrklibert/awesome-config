 ...
 * @see root.c:290
 * @param event_type Dynamic  The event type: key\_press, key\_release, button\_press,
  button\_release or motion\_notify.
 * @param detail Dynamic  The detail: in case of a key event, this is the keycode
