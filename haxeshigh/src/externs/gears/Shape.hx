...
extern class Shape {
     ...
     */
    static function partial_squircle(cr: Dynamic, width: Int, height: Int, tl: Bool, tr: Bool, br: Bool, bl: Bool, rate: Int, delta: Int): Void;
     ...
     * @param delta Int  The "smoothness" of the shape, delta must be greater than 0.01 and will be reset to 0.01 if not
     */
    static function squircle(cr: Dynamic, width: Int, height: Int, rate: Int, delta: Int): Void;
     ...
     */
    static function star(cr: Dynamic, width: Int, height: Int, n: Int): Void;
     ...
     */
    static function rounded_rect(cr: Dynamic, width: Int, height: Int, radius: Int): Void;
     ...
     */
    static function partially_rounded_rect(cr: Dynamic, width: Int, height: Int, tl: Bool, tr: Bool, br: Bool, bl: Bool, rad: Int): Void;
     ...
     */
    static function infobubble(cr: Dynamic, width: Int, height: Int, corner_radius: Int, arrow_size: Int, arrow_position: Int): Void;
     ...
     */
    static function rectangular_tag(cr: Dynamic, width: Int, height: Int, arrow_length: Int): Void;
     ...
     */
    static function arrow(cr: Dynamic, width: Int, height: Int, head_width: Int, shaft_width: Int, shaft_length: Int): Void;
     ...
     */
    static function powerline(cr: Dynamic, width: Int, height: Int, arrow_depth: Int): Void;
     ...
     */
    static function cross(cr: Dynamic, width: Int, height: Int, thickness: Int): Void;
     ...
     * @param width Int  The shape width
     * @param height Int  The shape height
     * @param corner_radius Int  <no desc>
     */
    static function octogon(cr: Dynamic, width: Int, height: Int, corner_radius: Int): Void;
     ...
     */
    static function circle(cr: Dynamic, width: Int, height: Int, radius: Int): Void;
     ...
     */
    static function parallelogram(cr: Dynamic, width: Int, height: Int, base_width: Int): Void;
     ...
     */
    static function pie(cr: Dynamic, width: Int, height: Int, start_angle: Int, end_angle: Int, radius: Int): Void;
     ...
     */
    static function arc(cr: Dynamic, width: Int, height: Int, thickness: Int, start_angle: Int, end_angle: Int, start_rounded: Bool, end_rounded: Bool): Void;
     ...
     */
    static function radial_progress(cr: Dynamic, w: Int, h: Int, percent: Int, hide_left: Bool): Void;
