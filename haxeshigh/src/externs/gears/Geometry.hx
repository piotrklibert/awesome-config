 ...
 */
static function get_closest_by_coord(list: lua.Table<String, Dynamic>, x: Int, y: Int);
/**
 ...
 * @param y Int  The y coordinate
 */
static function get_by_coord(list: lua.Table<String, Dynamic>, x: Int, y: Int);
/**
 ...
 */
static function get_in_direction(dir: String, recttbl: lua.Table<String, Dynamic>, cur: lua.Table<String, Dynamic>);
/**
 ...
 * @param b lua.Table<String, Dynamic>  The other area.
 */
static function area_intersect_area(a: lua.Table<String, Dynamic>, b: lua.Table<String, Dynamic>);
/**
 ...
 */
static function area_remove(areas: lua.Table<String, Dynamic>, elem: lua.Table<String, Dynamic>);
}
