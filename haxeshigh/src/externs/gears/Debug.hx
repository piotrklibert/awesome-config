 ...
 */
static function dump_return(data: Dynamic, tag: Dynamic, depth: int);
/**
 ...
 */
static function deprecate(see: Dynamic, args: lua.Table<String, Dynamic>);
/**
