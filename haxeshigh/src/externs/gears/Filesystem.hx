 ...
 */
static function make_directories(dir: String);
/**
 ...
 */
static function make_parent_directories(path: String);
/**
 ...
 */
static function get_configuration_dir();
/**
 ...
 */
static function get_dir(d: Dynamic);
/**
 ...
 * @param exts lua.Table<String, Dynamic>  Specific extensions to limit the search to. eg:`{ "jpg", "png" }`
   If ommited, all files are considered.
 * @param absolute_path Bool  Return the absolute path instead of the filename.
 */
static function get_random_file_from_dir(path: String, exts: lua.Table<String, Dynamic>, absolute_path: Bool): string|nil;
}
