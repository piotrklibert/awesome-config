 ...
 * @param target lua.Table<String, Dynamic>  The target table. Values from `source` will be copied
   into this table.
 * @param source lua.Table<String, Dynamic>  The source table. Its values will be copied into
   `target`.
 * @param raw bool  If `true`, values will be assigned with `rawset`.
 ...
 */
static function hasitem(t: lua.Table<String, Dynamic>, item: Dynamic): string|number;
/**
 * Get all matching table keys for a `matcher` function.
 * @see lib/gears/table.lua:141
 * @param t lua.Table<String, Dynamic>  The table.
 * @param matcher Function  A function taking the key and value as arguments and
   returning a boolean.
 * @param ordered Bool  If true, only look for continuous
   numeric keys.
 * @param max Int  The maximum number of entries to find.
 */
static function find_keys(t: lua.Table<String, Dynamic>, matcher: Function, ordered: Bool, max: Int): table|nil;
/**
 ...
 * @param ordered Bool  If true, only look for continuous
   numeric keys.
 */
static function find_first_key(t: lua.Table<String, Dynamic>, matcher: Function, ordered: Bool);
/**
 ...
 * @param deep bool  If `true`, recurse into nested tables to create
   a deep clone.
 */
 ...
 * @param step_size Int  The amount to increment the index by.
   When this is negative, the function will cycle through the table backwards.
 * @param filter Function  An optional filter function. It receives a
 ...
 */
static function cycle_value(t: lua.Table<String, Dynamic>, value: Dynamic, step_size: Int, filter: Function, start_at: Int);
/**
 * Iterate over a table.
 * @see lib/gears/table.lua:328
 * @param t lua.Table<String, Dynamic>  The table to iterate.
 * @param filter func  A function that returns true to indicate a positive
   match.
 * @param start int  Index to start iterating from.
 ...
 * @param new lua.Table<String, Dynamic>  The table which contains the new content.
 * @param identifier Function  A function which take the table entry (either
 ...
 * @param merger Function  A function takes the entry to modify as first
 ...
 */
static function diff_merge(target: lua.Table<String, Dynamic>, new: lua.Table<String, Dynamic>, identifier: Function, merger: Function): lua.Table<String, Dynamic>;
/**
 * Map a function to a table.
 * @see lib/gears/table.lua:453
 * @param f Function  The function to be applied to each value in the table.
 * @param tbl lua.Table<String, Dynamic>  The container table whose values will be operated on.
 */
static function map(f: Function, tbl: lua.Table<String, Dynamic>): lua.Table<String, Dynamic>;
}
