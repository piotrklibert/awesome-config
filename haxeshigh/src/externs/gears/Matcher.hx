...
extern class Matcher {
     ...
     * @param o Dynamic  The object.
     * @param rules lua.Table<String, Dynamic>  The rules to check. List with "rule", "rule_any", "except" and "except_any" keys. If no rules are provided, all rules registered with a source will be matched.
     */
    function matching_rules(o: Dynamic, rules: lua.Table<String, Dynamic>): Void;

    /** Check if an object matches a given set of rules.
     *
     * @see lib/gears/matcher.lua:426
     * @param o Dynamic  The object.
     * @param rules lua.Table<String, Dynamic>  The rules to check. List of tables with `rule`, `rule_any`, `except` and `except_any` keys.
     */
     ...
     * @param f haxe.Constraints.Function  The matching function.
     */
    function add_property_matcher(name: String, f: haxe.Constraints.Function): Void;

    /** Add a special setter for a property.
     *
     * @see lib/gears/matcher.lua:482
     * @param name String  The property name.
     * @param f haxe.Constraints.Function  The setter function.
     */
    function add_property_setter(name: String, f: haxe.Constraints.Function): Void;

    /** Add a set of matching rules.
     *
     * @see lib/gears/matcher.lua:524
     * @param name String  The provider name. It must be unique.
     * @param rules lua.Table<String, Dynamic>  A set of rules (see how they work at the top of this page).
     ...
     * @param precede lua.Table<String, Dynamic>  A list of names of sources this source has a priority over.
     */
     ...
     * @param precede lua.Table<String, Dynamic>  A list of names of sources this source has a priority over.
     */
    function add_matching_function(name: String, callback: haxe.Constraints.Function, depends_on: lua.Table<String, Dynamic>, precede: lua.Table<String, Dynamic>): Bool;
     ...
     */
    function append_rule(source: String, rule: lua.Table<String, Dynamic>): Void;
     ...
     */
    function append_rules(source: String, rules: lua.Table<String, Dynamic>): Void;
