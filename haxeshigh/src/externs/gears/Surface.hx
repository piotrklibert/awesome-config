 ...
 * @param default Dynamic  The default value to return on error; when nil, then a surface
 in an error state is returned.
 */
static function load_uncached_silently(_surface: Dynamic, default: Dynamic);
/**
 * Try to convert the argument into an lgi cairo surface.
 ...
 */
static function load_from_shape(width: Int, height: Int, shape: Dynamic, shape_color: Dynamic, bg_color: Dynamic): cairo.surface;
/**
 * Apply a shape to a client or a wibox.
 * @see lib/gears/surface.lua:203
 * @param draw Dynamic  A wibox or a client
 * @param shape Dynamic  or gears.shape function or a custom function with a context,
   width and height as parameter.
 * @param Any Dynamic  additional parameters will be passed to the shape function.
 */
static function apply_shape_bounding(draw: Dynamic, shape: Dynamic, Any: Dynamic);
}
