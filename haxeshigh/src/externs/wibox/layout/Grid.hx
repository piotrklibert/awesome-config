 ...
 */
static function grid(orientation: String);
/**
 ...
 */
static function horizontal(forced_num_rows: Null<Int>, ...rest: externs.wibox.Widget);
/**
 ...
 * @param ...rest externs.wibox.Widget  Widgets that should be added to the layout.
 */
static function vertical(forced_num_cols: Null<Int>, ...rest: externs.wibox.Widget);
/**
 ...
 */
function get_next_empty(hint_row: Int, hint_column: Int);
/**
 ...
 * @param new Dynamic  The widget to add
 */
function replace_widget(old: Dynamic, new: Dynamic): Bool;
/**
 ...
 * @see lib/wibox/layout/grid.lua:1083
...
/**
 * Reset the layout.
 * @see lib/wibox/layout/grid.lua:1127
 */
function reset();
}
