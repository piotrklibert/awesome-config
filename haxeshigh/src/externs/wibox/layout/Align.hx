 ...
 */
static function horizontal(left: externs.wibox.Widget, middle: externs.wibox.Widget, right: externs.wibox.Widget);
/**
 ...
 */
static function vertical(top: externs.wibox.Widget, middle: externs.wibox.Widget, bottom: externs.wibox.Widget);
/**
