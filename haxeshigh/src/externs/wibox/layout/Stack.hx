 ...
 * @param recursive Bool  Also look deeper in the hierarchy to
   find the widget
 */
function raise_widget(widget: externs.wibox.Widget, recursive: Bool);
/**
