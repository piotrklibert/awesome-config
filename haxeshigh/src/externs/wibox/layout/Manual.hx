 ...
 * lib/wibox/layout/manual.lua:35
 */
/**
 ...
 * @param widget externs.wibox.Widget  The widget.
 * @param point haxe.extern.EitherType<lua.Table<String, Dynamic>, Function>  Either an `{x=x,y=y}` table or a function
  returning the new geometry.
 */
function add_at(widget: externs.wibox.Widget, point: haxe.extern.EitherType<lua.Table<String, Dynamic>, Function>);
/**
 * Move a widget (by index).
 * @see lib/wibox/layout/manual.lua:254
 * @param index Int  The widget index.
 * @param point haxe.extern.EitherType<lua.Table<String, Dynamic>, Function>  A new point value.
 */
function move(index: Int, point: haxe.extern.EitherType<lua.Table<String, Dynamic>, Function>);
/**
 * Move a widget.
 ...
 * @param point haxe.extern.EitherType<lua.Table<String, Dynamic>, Function>  A new point value.
 */
function move_widget(widget: externs.wibox.Widget, point: haxe.extern.EitherType<lua.Table<String, Dynamic>, Function>);
/**
