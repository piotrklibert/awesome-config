 ...
 * lib/wibox/widget/textbox.lua:23
 */
/**
 ...
 */
@:selfCall function new(text: String, ignore_markup: Bool);
/**
 ...
 * @param text String  The text to set. This can contain pango markup (e.g.
