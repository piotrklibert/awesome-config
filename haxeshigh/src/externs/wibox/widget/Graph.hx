 ...
 */
var step_shape: haxe.extern.EitherType<externs.gears.Shape, Function>;
/**
 ...
 * @param usable_width Int 
 */
function compute_drawn_values_num(usable_width: Int);
/**
 ...
 */
function add_value(value: Int, group: Int);
/**
 * Clear the graph.
