 ...
 * lib/wibox/widget/imagebox.lua:40
 */
/**
 ...
 */
var clip_shape: haxe.extern.EitherType<Function, externs.gears.Shape>;
/**
 ...
 * @param resize_allowed Bool  If `false`, the image will be
   clipped, else it will be resized to fit into the available space.
 * @param clip_shape Function  A `gears.shape` compatible function.
 */
@:selfCall function new(image: image, resize_allowed: Bool, clip_shape: Function);
/**
 ...
 * @param clip_shape haxe.extern.EitherType<Function, externs.gears.Shape>  A `gears_shape` compatible shape function.
 */
function set_clip_shape(clip_shape: haxe.extern.EitherType<Function, externs.gears.Shape>);
}
