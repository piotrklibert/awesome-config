 ...
 * lib/wibox/container/scroll.lua:27
 */
/**
 ...
 * @param expand Bool  Should the widget be expanded to include the
 extra space?
 ...
 */
static function horizontal(widget: Dynamic, fps: Dynamic, speed: Dynamic, extra_space: Dynamic, expand: Bool, max_size: Dynamic, step_function: Dynamic, space_for_scrolling: Dynamic);
/**
 ...
 * @param space_for_scrolling Dynamic  The space for scrolling
 */
static function vertical(widget: Dynamic, fps: Dynamic, speed: Dynamic, extra_space: Dynamic, expand: Bool, max_size: Dynamic, step_function: Dynamic, space_for_scrolling: Dynamic);
/**
 ...
 */
function set_extra_space(extra_space: Int);
/**
 ...
 */
function set_max_size(max_size: Int);
/**
 ...
 * @param step_function Function  A step function.
 */
function set_step_function(step_function: Function);
/**
 ...
 */
function set_space_for_scrolling(space_for_scrolling: Int);
}
