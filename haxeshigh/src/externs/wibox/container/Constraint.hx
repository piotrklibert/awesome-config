 ...
 * lib/wibox/container/constraint.lua:14
 */
/**
 ...
 * @param strategy Dynamic  How to constraint the size. 'max' (default), 'min' or
 'exact'.
 ...
 */
@:selfCall function new(widget: Dynamic, strategy: Dynamic, width: Dynamic, height: Dynamic);
/**
 * Reset this layout.
