 ...
 * @see luaa.c:243
 * @param pid Int  Process identifier.  0 and negative values have special
 ...
 */
static function pixbuf_to_surface(pixbuf: Dynamic, path: Dynamic);
/**
 * Load an image from a given path.
 * @see luaa.c:291
 * @param name Dynamic  The file name.
 */
static function load_image(name: Dynamic);
/**
 * Set the preferred size for client icons.
 * @see luaa.c:321
 * @param size Dynamic  The size of the icons in pixels.
 */
static function set_preferred_icon_size(size: Dynamic);
/**
 * Add a global signal.
 * @see luaa.c:776
 ...
 */
static function connect_signal(name: Dynamic, func: Dynamic);
/**
 ...
 * @param func Dynamic  The function to call.
 */
static function disconnect_signal(name: Dynamic, func: Dynamic);
/**
 ...
 */
static function emit_signal(name: Dynamic, ...rest: Dynamic);
/**
 * Spawn a program.
 * @see luaa.c:425
 * @param cmd lua.Table<String, Dynamic>  The environment to use for the spawned program.
 ...
 * @param exit_callback Function  Function to call on process exit. The
   function arguments will be type of exit ("exit" or "signal") and the exit
   code / the signal number causing process termination.
 * @param cmd lua.Table<String, Dynamic>  The environment to use for the spawned program.
   Without this the spawned process inherits awesome's environment.
 */
static function spawn(cmd: lua.Table<String, Dynamic>, use_sn: Bool, stdin: Bool, stdout: Bool, stderr: Bool, exit_callback: Function, cmd: lua.Table<String, Dynamic>): Int;
/**
 * Switch keyboard layout.
 * @see luaa.c:34
 * @param num Int  keyboard layout number, integer from 0 to 3
 */
static function xkb_set_layout_group(num: Int);
/**
