...
extern class Placement {
     ...
     * @param args lua.Table<String, Dynamic>  Other arguments&#34)
     */
    static function center_vertical(d: drawable, args: lua.Table<String, Dynamic>): Void;
     ...
     * @param args lua.Table<String, Dynamic>  Other arguments&#34)
     */
    static function maximize_vertically(d: drawable, args: lua.Table<String, Dynamic>): Void;
     ...
     * @param args lua.Table<String, Dynamic>  Other arguments&#34)
     */
    static function maximize_horizontally(d: drawable, args: lua.Table<String, Dynamic>): Void;
