 ...
 */
var panning_area: haxe.extern.EitherType<Function, String>;
/**
 * Create a wallpaper.
 ...
 */
function add_screen(screen: externs.Screen);
/**
 ...
 */
function remove_screen(screen: externs.Screen);
}
