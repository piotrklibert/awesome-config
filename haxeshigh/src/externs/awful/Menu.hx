...
extern class Menu {
     ...
     * @param args Dynamic  The arguments
     */
    function toggle(args: Dynamic): Void;
     ...
     */
    function add(args: Dynamic, index: Dynamic): Void;
     ...
     */
    function delete(num: Dynamic): Void;
     ...
     * @param filter func  A function taking a client as an argument and returning `true` or `false` to indicate whether the client should be included in the menu.
     */
    static function client_list(args: lua.Table<String, Dynamic>, item_args: lua.Table<String, Dynamic>, filter: func): Void;
