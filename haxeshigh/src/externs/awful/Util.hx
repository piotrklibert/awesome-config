...
extern class Util {
     ...
     */
    static function checkfile(path: Dynamic): Void;
     ...
     * @param size String  The size. If this is specified, subdirectories `x` of the dirs are searched first.
     */
    static function geticonpath(iconname: Dynamic, exts: Dynamic, dirs: Dynamic, size: String): Void;
}
