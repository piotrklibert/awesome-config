...
extern class Tooltip extends externs.Wibox {
     ...
     * @param obj gears.object  An object with `mouse::enter` and `mouse::leave` signals.
     */
    function add_to_object(self: tooltip, obj: gears.object): Void;
     ...
     * @param obj gears.object  An object with `mouse::enter` and `mouse::leave` signals.
     */
    function remove_from_object(self: tooltip, obj: gears.object): Void;
