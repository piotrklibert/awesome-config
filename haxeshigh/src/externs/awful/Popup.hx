 ...
 * @param obj Dynamic  An object such as a wibox, client or a table entry
 ...
 */
function bind_to_widget(widget: externs.wibox.Widget, button: Int);
/**
 * Unbind the popup from a widget button.
 * @see lib/awful/popup.lua:418
 * @param widget externs.wibox.Widget  The widget
 */
function unbind_to_widget(widget: externs.wibox.Widget);
/**
