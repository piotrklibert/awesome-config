...
extern class Completion {
    /** Completion module.
     * @see lib/awful/completion.lua:12
     */
     ...
     */
    static function bashcomp_load(src: Dynamic): Void;
     ...
     */
    static function generic(text: Dynamic, cur_pos: Dynamic, ncomp: Dynamic, keywords: Dynamic): Void;
}
