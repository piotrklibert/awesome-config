...
extern class Spawn {
     ...
     * @param sn_rules haxe.extern.EitherType<lua.Table<String, Dynamic>, Bool>  A table of properties to be applied after startup; `false` to disable startup notifications.
     * @param callback haxe.Constraints.Function  A callback function to be run after startup.
     */
    static function spawn(cmd: haxe.extern.EitherType<String, lua.Table<String, Dynamic>>, sn_rules: haxe.extern.EitherType<lua.Table<String, Dynamic>, Bool>, callback: haxe.Constraints.Function): Int;
     ...
     */
    static function read_lines(input_stream: Gio.InputStream, line_callback: haxe.Constraints.Function, done_callback: haxe.Constraints.Function, close: Bool): Void;
     ...
     */
    static function once(cmd: haxe.extern.EitherType<String, lua.Table<String, Dynamic>>, rules: lua.Table<String, Dynamic>, matcher: haxe.Constraints.Function, unique_id: String, callback: haxe.Constraints.Function): Void;
     ...
     * @param callback haxe.Constraints.Function  A callback function when the client is created.
     */
    static function single_instance(cmd: haxe.extern.EitherType<String, lua.Table<String, Dynamic>>, rules: lua.Table<String, Dynamic>, matcher: haxe.Constraints.Function, unique_id: String, callback: haxe.Constraints.Function): Void;
     ...
     * @param callback haxe.Constraints.Function  A callback function when the client is created.
     */
    static function raise_or_spawn(cmd: haxe.extern.EitherType<String, lua.Table<String, Dynamic>>, rules: lua.Table<String, Dynamic>, matcher: haxe.Constraints.Function, unique_id: String, callback: haxe.Constraints.Function): externs.Client;
}
