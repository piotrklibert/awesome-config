 ...
 * lib/awful/hotkeys_popup/init.lua:9
 */
/**
 ...
 */
static function add_rules_for_terminal(rule: lua.Table<String, Dynamic>);
/**
 ...
 */
static function show_help(c: externs.Client, s: externs.Screen);
}
