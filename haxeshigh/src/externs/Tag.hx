 ...
 */
var layout: haxe.extern.EitherType<layout, Function>;
/**
 ...
 */
var icon: haxe.extern.EitherType<path, surface>;
/**
 ...
 * @param clients_table lua.Table<String, Dynamic>  None or a table of clients to set as being tagged with
  this tag.
 */
function clients(clients_table: lua.Table<String, Dynamic>);
/**
 * Swap 2 tags.
 * @see objects/tag.c:249
 * @param tag2 tag  The second tag
 */
function swap(tag2: tag);
/**
 * Remove all tagged clients.
 * @see objects/tag.c:423
 * @param args lua.Table<String, Dynamic>  The arguments.
 */
function clear(args: lua.Table<String, Dynamic>);
/**
 * Delete a tag.
 * @see objects/tag.c:476
 * @param fallback_tag tag  Tag to assign
  stickied tags to.
 * @param force Bool  Move even non-sticky clients to the fallback
 tag.
 */
function delete(fallback_tag: tag, force: Bool);
/**
 * View only a tag.
 ...
 */
static function new(names: lua.Table<String, Dynamic>, screen: haxe.extern.EitherType<externs.Screen, Int>, layout: lua.Table<String, Dynamic>): lua.Table<String, Dynamic>;
/**
 ...
 */
static function find_fallback(screen: externs.Screen, invalids: Null<lua.Table<String, Dynamic>>);
/**
 * Update the tag history.
 * @see objects/tag.c:555
 * @param obj externs.Screen  Screen object.
 */
static function update(obj: externs.Screen);
/**
 * Revert tag history.
 * @see objects/tag.c:599
 * @param screen externs.Screen  The screen.
 * @param idx Int  Index in history. Defaults to "previous" which is a special index
 toggling between last two selected sets of tags. Number (eg 1) will go back
 to the given index in history.
 */
static function restore(screen: externs.Screen, idx: Int);
/**
 * Find a tag by name.
 ...
 */
static function find_by_name(s: externs.Screen, name: String);
/**
 * Increase master width factor.
 * @see objects/tag.c:833
 * @param add Int  Value to add to master width factor.
 * @param t tag  The tag to modify, if null tag.selected() is used.
 */
static function incmwfact(add: Int, t: tag);
/**
 ...
 * @param screen externs.Screen  The screen.
 */
static function viewidx(i: Int, screen: externs.Screen);
/**
 * View next tag.
 * @see objects/tag.c:1783
 * @param screen externs.Screen  The screen.
 */
static function viewnext(screen: externs.Screen);
/**
 * View previous tag.
 * @see objects/tag.c:1811
 * @param screen externs.Screen  The screen.
 */
static function viewprev(screen: externs.Screen);
/**
 ...
 */
static function viewmore(tags: lua.Table<String, Dynamic>, screen: externs.Screen, maximum: Int);
/**
 * Toggle selection of a tag
 * @see objects/tag.c:1901
 * @param t tag  Tag to be toggled
 */
static function viewtoggle(t: tag);
/**
 ...
 */
static function attached_connect_signal(screen: externs.Screen, signal: String, Callback: Function);
}
