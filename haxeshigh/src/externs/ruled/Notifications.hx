 ...
 * lib/ruled/notification.lua:200
 */
/**
 * Remove a source.
 ...
 */
static function apply(n: naughty.notification);
/**
 ...
 */
static function append_rules(rule: lua.Table<String, Dynamic>);
/**
 * Remove a new rule to the default set.
 * @see lib/ruled/notification.lua:398
 * @param rule lua.Table<String, Dynamic>  A valid rule.
 */
static function remove_rule(rule: lua.Table<String, Dynamic>);
/**
