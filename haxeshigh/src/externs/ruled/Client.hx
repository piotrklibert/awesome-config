 ...
 */
static function append_rule(rule: lua.Table<String, Dynamic>);
/**
 * Add a new rules to the default set.
 * @see lib/ruled/client.lua:388
 * @param rules lua.Table<String, Dynamic>  A table with rules.
 */
static function append_rules(rules: lua.Table<String, Dynamic>);
/**
 * Remove a new rule to the default set.
 * @see lib/ruled/client.lua:395
 * @param rule haxe.extern.EitherType<lua.Table<String, Dynamic>, String>  A valid rule or a name passed in the `id` value
  when calling `append_rule`.
 */
static function remove_rule(rule: haxe.extern.EitherType<lua.Table<String, Dynamic>, String>);
/**
 ...
 * @param c externs.Client  The client.
 * @param _rules lua.Table<String, Dynamic>  The rules to check. List with "rule", "rule_any", "except" and
   "except_any" keys.
 */
 ...
 * @param c externs.Client  The client.
 * @param _rules lua.Table<String, Dynamic>  The rules to check. List of tables with `rule`, `rule_any`,
 ...
 * @param c externs.Client  The client.
 */
static function apply(c: externs.Client);
/**
 ...
 * @param precede lua.Table<String, Dynamic>  A list of names of sources this source have a
  priority over.
 */
static function add_rule_source(name: String, callback: Function, depends_on: lua.Table<String, Dynamic>, precede: lua.Table<String, Dynamic>): Bool;
/**
 ...
 */
static function execute(c: externs.Client, props: lua.Table<String, Dynamic>, callbacks: lua.Table<String, Dynamic>);
}
