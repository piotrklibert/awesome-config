...
__utils_WidgetPreview.prototype.connect_signals = function(self) 
  ...
  self.wibox:connect_signal("mouse::move", function() 
    ...
    if (_gthis.is_pressed) then 
      local fh = _gthis.wibox;
      fh.x = fh.x + (coords.x - _gthis.prev_coords.x);
      local fh = _gthis.wibox;
      fh.y = fh.y + (coords.y - _gthis.prev_coords.y);
    end;
...
__battery_Pkg.prototype.unload = function(self) 
  ...
  __log_Log.log("Battery(" .. __battery_Pkg.ver .. "): unload!", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug2.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/battery/Pkg.hx",lineNumber=35,className="battery.Pkg",methodName="unload"}));
end
__battery_Pkg.prototype.load = function(self) 
  ...
  __log_Log.log("Battery(" .. __battery_Pkg.ver .. ") loaded", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug2.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/battery/Pkg.hx",lineNumber=40,className="battery.Pkg",methodName="load"}));
end
...
local _hx_static_init = function()
  ...
  String.__name__ = true;
  Array.__name__ = true;
  _G.Logger = __log_Log;__utils_WidgetPreview.ver = "1657461443";
  
  __battery_Pkg.ver = "1657461443";
