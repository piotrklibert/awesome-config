...
Loader.main = function() 
  ...
  local _hx_status, _hx_result = pcall(function() 
      ...
      __log_Log.log("Loader: loading package \"" .. pkg .. "\"...", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug4.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Loader.hx",lineNumber=20,className="Loader",methodName="main"}));
      cmd.PackageManager:load(pkg, true);
      local ret = __log_Log.backgrounds.h["Info"];
      if (ret == __haxe_ds_StringMap.tnull) then 
        ret = nil;
      end;
      __log_Log.log("Loader: loading package \"" .. pkg .. "\" finished!", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug2.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Loader.hx",lineNumber=22,className="Loader",methodName="main"}));
  ...
  elseif not _hx_status then 
    ...
    if (__lua_Boot.__instanceof(_g1, String)) then 
      ...
      __log_Log.log("Loader: error loading package \"" .. pkg .. "\"!", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/error2.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Loader.hx",lineNumber=26,className="Loader",methodName="main"}));
      local ret = __log_Log.backgrounds.h["Debug"];
      if (ret == __haxe_ds_StringMap.tnull) then 
        ret = nil;
      end;
      __log_Log.log(_g1, _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug4.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Loader.hx",lineNumber=27,className="Loader",methodName="main"}));
    else
      _G.error(_g,0);
    end;
