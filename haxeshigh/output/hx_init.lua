...
__init_Init.main = function() 
  ...
  local x = _hx_o({__fields__={x=true,f=true,g=true},x=4,f=44,g="ggg"});
  __haxe_Log.trace(({x,x,x}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/init/Init.hx",lineNumber=8,className="init.Init",methodName="main"}));
  __haxe_Log.trace(#({1,2,3}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/init/Init.hx",lineNumber=9,className="init.Init",methodName="main"}));
  local z = x.__fields__;
  local _g = 0;
  local _g1 = Reflect.fields(z);
  while (_g < _g1.length) do 
    local a = _g1[_g];
    _g = _g + 1;
    __haxe_Log.trace(a, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/init/Init.hx",lineNumber=12,className="init.Init",methodName="main"}));
  end;
  __haxe_Log.trace(z, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/init/Init.hx",lineNumber=14,className="init.Init",methodName="main"}));
end
