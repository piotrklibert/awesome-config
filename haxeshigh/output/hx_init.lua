...
__init_Pkg.prototype.unload = function(self) 
  ...
  __log_Log.log("INIT(" .. __init_Pkg.ver .. "): unload!", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug2.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/init/Pkg.hx",lineNumber=34,className="init.Pkg",methodName="unload"}));
end
__init_Pkg.prototype.load = function(self) 
  ...
  __log_Log.log("INIT(" .. __init_Pkg.ver .. ") loaded!!!", _hx_o({__fields__={bg=true,icon=true},bg=ret,icon="" .. __log_Log.res_path .. "/debug2.png"}), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/init/Pkg.hx",lineNumber=38,className="init.Pkg",methodName="load"}));
end
...
__init_Transcript.setup = function(wibox,widget) 
  ...
  local setupTable = __awful_Wibox.widget(_tmp_1);
  local prev_coords = _hx_o({__fields__={x=true,y=true},x=0,y=0});
  local is_pressed = false;
  wibox:setup(__utils_lua__LuaTools_LuaTable_Impl_.fromObject(setupTable));
...
__init_Transcript.makeText = function(pos) 
  ...
  do return "<span foreground=\"blue\">" .. __init_Transcript.ver .. "</span>\n<b>" .. Std.string(pos.x) .. "x" .. Std.string(pos.y) .. "</b>!!!" end;
end
