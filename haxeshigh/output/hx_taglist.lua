...
__taglist_Pkg.prototype.load = function(self) 
  ...
  elseif not _hx_status then 
    local _g = _hx_result;
    __log_Log.log(Std.string("Error loading taglist module: ") .. Std.string(Std.string(__haxe_Exception.caught(_g):unwrap())), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/taglist/Pkg.hx",lineNumber=34,className="taglist.Pkg",methodName="load"}));
  elseif _hx_result ~= _hx_pcall_default then
    return _hx_result
  end;
end
...
__taglist_TaglistAnimator.prototype.autoHide = function(self,n) 
  ...
  self.timers.hide_timer = __haxe_ds_Option.Some(tmp);
end
