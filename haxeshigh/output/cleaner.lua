...
local Array = _hx_e()
local Cleaner = _hx_e()
local __lua_lib_luautf8_Utf8 = _G.require("utf8")
local Lambda = _hx_e()
local Math = _hx_e()
local Reflect = _hx_e()
local String = _hx_e()
...
Cleaner.main = function() 
  ...
  __log_Log.log("Cleaner: removing package \"" .. pkg .. "\"...", nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=17,className="Cleaner",methodName="main"}));
  local _hx_status, _hx_result = pcall(function() 
  
      if (not cmd.PackageManager:unload(pkg, true)) then 
        Cleaner.handleError(pkg);
      else
        __log_Log.log("Cleaner: package \"" .. pkg .. "\" removed!", nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=23,className="Cleaner",methodName="main"}));
      end;
...
Cleaner.handleError = function(pkg,ex) 
  ...
  __log_Log.log("Cleaner: removing package \"" .. pkg .. "\" failed!", nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=31,className="Cleaner",methodName="handleError"}));
  if (__lua_lib_luautf8_Utf8.len(ex) > 0) then 
    __log_Log.log("Exception data:\n" .. __utils_Common.formatSimpleEx(ex), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=33,className="Cleaner",methodName="handleError"}));
  end;
end
...
__utils_Common.formatSimpleEx = function(exception) 
  ...
  local _hx_status, _hx_result = pcall(function() 
      ...
      while (idx ~= nil) do 
        ...
        if (newidx ~= nil) then 
          local match = __lua_lib_luautf8_Utf8.sub(ex, idx, newidx - 1);
          ret:push(match);
          idx = newidx + __lua_lib_luautf8_Utf8.len(":");
        else
