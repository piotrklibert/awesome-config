...
Cleaner.main = function() 
  ...
  __log_Log.log(Std.string(Std.string("Cleaner: removing package \"") .. Std.string(pkg)) .. Std.string("\"..."), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=17,className="Cleaner",methodName="main"}));
  local _hx_status, _hx_result = pcall(function() 
  
      if (not cmd.PackageManager:unload(pkg, true)) then 
        Cleaner.handleError(pkg);
      else
        __log_Log.log(Std.string(Std.string("Cleaner: package \"") .. Std.string(pkg)) .. Std.string("\" removed!"), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=23,className="Cleaner",methodName="main"}));
      end;
...
Cleaner.handleError = function(pkg,ex) 
  ...
  __log_Log.log(Std.string(Std.string("Cleaner: removing package \"") .. Std.string(pkg)) .. Std.string("\" failed!"), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=31,className="Cleaner",methodName="handleError"}));
  if (__lua_lib_luautf8_Utf8.len(ex) > 0) then 
    __log_Log.log(Std.string("Exception data:\n") .. Std.string(__utils_Common.formatSimpleEx(ex)), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=33,className="Cleaner",methodName="handleError"}));
  end;
end
...
__pkg_PackageManager.prototype.unload = function(self,name,remove) 
  ...
  if (pkg == nil) then 
    __log_Log.log(Std.string(Std.string("ERROR: \"") .. Std.string(name)) .. Std.string("\" not found!"), nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/pkg/PackageManager.hx",lineNumber=65,className="pkg.PackageManager",methodName="unload"}));
    do return false end;
  else
    if (remove) then 
      self:remove(pkg);
...
__utils_Common.formatSimpleEx = function(exception) 
  ...
  elseif not _hx_status then 
    local _g = _hx_result;
    do return "<error formatting error>" end;
  elseif _hx_result ~= _hx_pcall_default then
    return _hx_result
  end;
end
...
_hx_static_init();
_G.xpcall(Cleaner.main, _hx_error)
return _hx_exports
