...
Cleaner.main = function() 
  ...
  __utils_NaughtyLogger.raw(Std.string(Std.string("Cleaner: removing package \"") .. Std.string(pkg1)) .. Std.string("\"..."));
  local _hx_status, _hx_result = pcall(function() 
  
      if (not cmd.PackageManager:unload(pkg1, true)) then 
        Cleaner.handleError(pkg1);
      else
        __utils_NaughtyLogger.raw(Std.string(Std.string("Cleaner: package \"") .. Std.string(pkg1)) .. Std.string("\" removed!"));
      end;
...
Cleaner.handleError = function(pkg,ex) 
  ...
  __utils_NaughtyLogger.raw(Std.string(Std.string("Cleaner: removing package \"") .. Std.string(pkg)) .. Std.string("\" failed!"));
  if (__lua_lib_luautf8_Utf8.len(ex) > 0) then 
    __utils_NaughtyLogger.raw(Std.string("Exception data:\n") .. Std.string(__utils_Common.formatSimpleEx(ex)));
  end;
end
...
__utils_NaughtyLogger.__name__ = true
__utils_NaughtyLogger.raw = function(x) 
  __awful_Naughty.notify(_hx_o({__fields__={text=true},text=Std.string(x)}));
end
