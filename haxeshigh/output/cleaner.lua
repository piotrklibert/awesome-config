...
Cleaner.main = function() 
  ...
  __log_Log.log(Std.string(Std.string("Cleaner: removing package \"") .. Std.string(pkg)) .. Std.string("\"..."), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=17,className="Cleaner",methodName="main"}));
  local _hx_status, _hx_result = pcall(function() 
  
      if (not cmd.PackageManager:unload(pkg, true)) then 
        Cleaner.handleError(pkg);
      else
        __log_Log.log(Std.string(Std.string("Cleaner: package \"") .. Std.string(pkg)) .. Std.string("\" removed!"), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Cleaner.hx",lineNumber=23,className="Cleaner",methodName="main"}));
      end;
