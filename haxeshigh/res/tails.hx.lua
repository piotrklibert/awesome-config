...
Tails.main = function() 
  __haxe_Log.trace(Tails.g(0), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Tails.hx",lineNumber=14,className="Tails",methodName="main"}));
end
...
_hx_static_init();
_G.xpcall(Tails.main, _hx_error)
